...
if (isset($_POST['btn'])) {
    ...
    if (Utilidades::errorNombreDuplicado('nombre', $nombre)) {
        $errores = true;
    }
...
<body style="background-color:white">
    <h3 class="my-2 text-xl text-center mt-10 font-bold">CREAR ARTÍCULO</h3>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center mb-4">
                    <input id="checkbox" type="checkbox" name="disponible" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="mb-6">
                <div class="flex w-full">
                    ...
                    <div class="ml-10">
                        <img src="./img/default.jpg" class="w-60" id="img">
                    </div>
                </div>

                <div class="flex flex-row-reverse mt-4">
                    <button type="submit" class="my-2 bg-blue-400 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" name="btn"><i class="fas fa-save mr-2"></i>CREAR</button>
